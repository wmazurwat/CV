...
\begin{itemize}
  ...
  \item
	...
	\end{itemize*}
		\textbf{Projects:} \\
		\href{https://apkpure.com/goboz/net.mbc.gobo}{GOBOZ}
		\\
		VOD(Video on demand) service made for \href{https://www.mbc.net/}{MBC}
		Targeted for both mobile and web, build from same codebase. 
		\\
		Role: mainly React Native, Android(Java) and iOS(ObjC) when needed
		\\ \\
		\textbf{BubblesU}
		\\ Customizable book printing service
		\\ React, NodeJS
\\ \\
		\textbf{My Puppy baby}
		\\ Like instagram but for pets
		\\ ReactNative, NodeJS
\\ \\
		\href{https://play.google.com/store/apps/details?id=com.dubit.nudge&hl=en_US}{Nudge}
